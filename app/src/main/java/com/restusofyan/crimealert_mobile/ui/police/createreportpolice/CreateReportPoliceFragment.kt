package com.restusofyan.crimealert_mobile.ui.police.createreportpolice
...
import com.restusofyan.crimealert_mobile.ui.users.createreport.CreateReportViewModel

class CreateReportPoliceFragment : Fragment() {

    private lateinit var imagePreview: ImageView
    private lateinit var cameraLauncher: ActivityResultLauncher<Intent>
    private lateinit var requestPermissionLauncher: ActivityResultLauncher<String>

    private val viewModel: CreateReportPoliceViewModel by viewModels()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        val view = inflater.inflate(R.layout.fragment_create_report_police, container, false)
